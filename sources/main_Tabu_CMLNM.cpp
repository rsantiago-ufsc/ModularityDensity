...
#include "../../heuristics/localsearch/tabusearch.h"
using namespace std;
...
//cout<<lg.numberOfEdges<<"aaa\n";
    ...
    TabuSearch ts(&lg, &modu);
//cout<<lg.numberOfEdges<<"bbb\n";


    //cout<<"Antes: Modularity: "<<modu.calculateDensity(&sol)<<endl;
    Solution * res = ts.execute(&sol,atof(parameter.c_str()),10000.0,1000);
