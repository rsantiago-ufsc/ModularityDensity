#include "graphcoarsenersinglesteplg.h"



GraphCoarsenerSingleStepLG::GraphCoarsenerSingleStepLG(LargeGraph * graph, fibonacci_heap<DataGCSSLG> * heap, unsigned type, bool usesHeap)
{
...
unsigned GraphCoarsenerSingleStepLG::merge(unsigned Ca, unsigned Cb, long double deltaDensity){
...
Solution * GraphCoarsenerSingleStepLG::toSolution(){
...
unsigned GraphCoarsenerSingleStepLG::unmerge(std::pair < NodeDetail, NodeDetail > & level,
