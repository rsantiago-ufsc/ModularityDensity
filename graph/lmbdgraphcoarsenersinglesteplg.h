...
class LMBDGraphCoarsenerSingleStepLG;
...
class DataGCSSLG{
public:
    LMBDGraphCoarsenerSingleStepLG * gcss;
    ...
    DataGCSSLG(LMBDGraphCoarsenerSingleStepLG * g, unsigned v1, unsigned v2, long double dens, long double relDegree, long double w, unsigned t = TYPE_PRI_DENSITY);
...
public:
    float lambda;
    LMBDGraphCoarsenerSingleStepLG(LargeGraph * graph, fibonacci_heap<DataGCSSLG> * heap, float lambda, unsigned type = TYPE_PRI_DENSITY, bool usesHeap=true);
    unsigned type;
...
DataGCSSLG::DataGCSSLG(LMBDGraphCoarsenerSingleStepLG * g, unsigned v1, unsigned v2, long double dens, long double relDegree, long double w, unsigned t):
...
#include "lmbdgraphcoarsenersinglesteplg.cpp"
