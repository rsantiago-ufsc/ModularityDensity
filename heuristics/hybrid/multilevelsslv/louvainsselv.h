...
public:
    ...
    LouvainSSELV(LargeGraph * graph, GraphCoarsenerSingleStepLG * GraphCoarsenerSingleStepLG, unsigned type=MLSSLV_DENS);
    void update(GraphCoarsenerSingleStepLG * gcss);


    GraphCoarsenerSingleStepLG * gl;
