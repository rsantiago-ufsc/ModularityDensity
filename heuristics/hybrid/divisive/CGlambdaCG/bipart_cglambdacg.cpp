...
Bipart_CGLambdaCG::Bipart_CGLambdaCG(LargeGraph * lg, double alpha){
    this->graph = lg;
    this->alpha = alpha;
...
void Bipart_CGLambdaCG::execute(vector<unsigned> &nodes){
...
void Bipart_CGLambdaCG::coefOF(vector<unsigned> &cluster, IloNum &coef, IloNumArray &A){
...
void Bipart_CGLambdaCG::prepareWij(IloNum **&wij){
    //memory allocation
...
void Bipart_CGLambdaCG::prepareDi (IloNum *&di){
