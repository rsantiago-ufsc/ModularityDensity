...
GraphLouvain::GraphLouvain(LargeGraph * graph)
{
...
unsigned GraphLouvain::merge(unsigned Ca, unsigned Cb, long double deltaDensity){
...
Solution * GraphLouvain::toSolution(){
