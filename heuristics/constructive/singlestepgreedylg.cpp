...
SingleStepGreedyLG::SingleStepGreedyLG(LargeGraph * graph)
{
    this->graph = graph;
...
void SingleStepGreedyLG::execute(){
    ...
    this->gcss = new GraphCoarsenerSingleStepLG (this->graph,heap,TYPE_PRI_DENSITY);
...
Solution * SingleStepGreedyLG::bestToSolution(){
...
void SingleStepGreedyLG::start(){
    ...
    this->gcss = new GraphCoarsenerSingleStepLG (this->graph,heap);



}
void SingleStepGreedyLG::nextLevel(){
//    while (heap->empty() == false){
